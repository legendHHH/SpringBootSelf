package com.qcl.generator.config;

import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.baomidou.mybatisplus.generator.config.po.LikeTable;
import com.qcl.generator.model.GenTableColumn;
import com.qcl.generator.type.EntityFiledType;
import com.qcl.generator.type.EntityType;
import com.qcl.generator.type.SuperClass;
...
public class CodeGeneratorConfig {
    ...
    /**
     * 子模块是否单独生成 {childModuleName}-entity模块
     */
...
//    private String serverSuffix = "-server";
     ...
     * 驱动连接的URL
     */
    private String url = "jdbc:mysql://localhost:3306/mybatis-plus?serverTimezone=CTT&characterEncoding=utf8&useUnicode=true&useSSL=false&autoReconnect=true&zeroDateTimeBehavior=convertToNull";
    /**
     * 驱动名称
     */
